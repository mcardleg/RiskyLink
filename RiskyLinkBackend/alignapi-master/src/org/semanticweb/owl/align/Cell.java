...
public interface Cell extends Comparable<Cell>, Visitable {
    ...
    /** Creation **/
    /**
     * @return the Id of the cell (null if there is no id)
     */
    public String getId();
    ...
    /**
     * @return the URI of the object of the first ontology
     * @throws AlignmentException if something goes wrong (has no URI)
    ...
    // V5: This will have to be Set<Cell> compose...
