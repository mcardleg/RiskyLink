 ...
 * $Id$
 *
 * Copyright (C) INRIA, 2009-2010, 2012-2013, 2017
 *
...
public class SKOSThesaurus extends BasicOntology<SKOSDataset> implements HeavyLoadedOntology<SKOSDataset>{
     ...
     */
    private final static HashSet<Object> NullSet = new HashSet<Object>();
...
lang = untypedLiteral.getLang();
     ...
     *
     * @param o: the concept whose property value is sought
     * @param p: the sought property
     * @param result: a set of strings containing the result
     */
    private void getDataValues( SKOSConcept o, SKOSDataProperty p, Set<String> result ){
	for ( SKOSLiteral lit : onto.getSKOSDataRelationByProperty( o, p ) ){
                result.add( lit.getLiteral() );
	}
    }
		  
    private void getDataValues( SKOSConcept o, SKOSDataProperty p, Set<String> result, String lang ){
	for ( SKOSLiteral lit : onto.getSKOSDataRelationByProperty( o, p ) ){
	    if ( !lit.isTyped() ) {
     ...
     * Returns one of the prefLabel property values for a given SKOS concept.
     *
     * @param o: the entity whose name is sought
     ...
     *
     * @param o: the entity whose prefered label is sought
     * @param lang: the code of the language ("en", "fr", "es", etc.) 
     * @return the preferred label in the given language if available
     * @throws OntowrapException when something goes wrong
     * JE: This is not satisfying because in case of several PrefLabels it will return the first one...
     */
     ...
     *
     * @param o: the entity whose preferred labels are sought
     * @param lang: the code of the language ("en", "fr", "es", etc.) 
     * @return the set of preferred label in the given language if available
     * @throws OntowrapException when something goes wrong
     */
     ...
     *
     * @param o: the concept
     * @return the set of labels of the concept
     * @throws OntowrapException when something goes wrong
     */
     ...
     *
     * @param o: the concept the comments on which are sought
     * @param lang: the code of the language ("en", "fr", "es", etc.) 
     * @return the set of comments in the given language
     * @throws OntowrapException when something goes wrong
     */
	...
	*/
     ...
     *
     * @param o: the concept the comments on which are sought
     * @return the set of comments on the concept
     * @throws OntowrapException when something goes wrong
     */
     ...
     *
     * @param o: the concept the annotations on which are sought
     * @return the set of annotations on the concept
     * @throws OntowrapException when something goes wrong
     */
     ...
     * @param o: the concept the annotations on which are sought
     * @param lang: the code of the language ("en", "fr", "es", etc.) 
     * @return the set of annotations on the concept in the given language
     * @throws OntowrapException when something goes wrong
     */
