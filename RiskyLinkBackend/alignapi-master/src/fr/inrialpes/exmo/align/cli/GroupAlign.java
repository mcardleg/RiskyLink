 ...
 * $Id$
 *
 * Copyright (C) 2003-2008, 2010-2015, 2017 INRIA
	...
	try {
	    ...
	    try ( PrintWriter writer = new PrintWriter (
                         new BufferedWriter(
						    ...
						    new FileOutputStream(dir+File.separator+outputfilename), StandardCharsets.UTF_8.name() )), true) ) {
	    ...
	    } catch (OntowrapException awex) {
		logger.debug( "IGNORED Exception on clear", awex );
	    };
	}
    }
