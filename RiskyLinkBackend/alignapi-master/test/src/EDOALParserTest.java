 ...
 * $Id$
 *
 * Copyright (C) INRIA, 2009-2011, 2015, 2017-2018
 *
...
public class EDOALParserTest {
	...
	*/
    ...
    /**
     * checks if two expressions in the input have the same type
     * Property / Relation
     */
    @Test(groups = {"full", "omwg", "raw"}, dependsOnMethods = {"linkkeyAlgebraParsingTest"}, expectedExceptions = org.semanticweb.owl.align.AlignmentException.class)
    public void doublyTypedExpression1() throws Exception {
        aparser1.initAlignment(null);
        Alignment alignment = aparser1.parse("file:test/input/ontokey1.rdf");
    }
     ...
     */
    @Test(groups = {"full", "omwg", "raw"}, dependsOnMethods = {"linkkeyAlgebraParsingTest"}, expectedExceptions = org.semanticweb.owl.align.AlignmentException.class)
    public void doublyTypedExpression2() throws Exception {
        aparser1.initAlignment(null);
        Alignment alignment = aparser1.parse("file:test/input/ontokey2.rdf");
    }
