 ...
 * $Id$
 *
 * Copyright (C) INRIA, 2008-2010, 2013-2015, 2017
 *
...
public class AlgTest {
	...
	PrintWriter writer2 = new PrintWriter (
			      new BufferedWriter(
			       new OutputStreamWriter( stream2, StandardCharsets.UTF_8.name() )), true);
	...
	PrintWriter writer3 = new PrintWriter (
			      new BufferedWriter(
			       new OutputStreamWriter( stream3, StandardCharsets.UTF_8.name() )), true);
