...
export serv=http://aserv.inrialpes.fr
...
# load
curl -L -H "Accept: text/xml" $serv'/rest/load?url=https://moex.gitlabpages.inria.fr/alignapi/tutorial/refalign.rdf&pretty=le%20test'

export alid=

# match
curl -L -H "Accept: text/xml" $serv'/rest/match?onto1=https://moex.gitlabpages.inria.fr/alignapi/tutorial/myOnto.owl&onto2=https://moex.gitlabpages.inria.fr/alignapi/tutorial/edu.mit.visus.bibtex.owl&force=true&pretty=test%20rest'

# find
curl -L -H "Accept: text/xml" $serv'/rest/find?onto2=https://moex.gitlabpages.inria.fr/alignapi/tutorial/edu.mit.visus.bibtex.owl'
...
# align
curl -L -H "Accept: text/xml" $serv'/rest/align?onto2=https://moex.gitlabpages.inria.fr/alignapi/tutorial/myOnto.owl&onto1=https://moex.gitlabpages.inria.fr/alignapi/tutorial/edu.mit.visus.bibtex.owl'

# translate
curl -L -H "Accept: text/xml" $serv'/rest/translate?id='$alid'&query=PREFIX%20rdf%3A%20%3Chttp%3A%2F%2Fwww.w3.org%2F1999%2F02%2F22-rdf-syntax-ns%23%3E%0APREFIX%20onto1%3A%20%3Chttps%3A%2F%2Fmoex.gitlabpages.inria.fr%2Falignapi%2Ftutorial%2FmyOnto.owl%23%3E%0ASELECT%20*%0AFROM%20%3C%3E%0AWHERE%20%7B%0A%3FX%20rdf%3Atype%20onto1%3AArticle.%0A%7D'

# eval
curl -L -H "Accept: text/xml" $serv'/rest/eval?id='$alid'&ref='alid'&method=fr.inrialpes.exmo.align.impl.eval.PRecEvaluator'

# corresp
curl -L -H "Accept: text/xml" $serv'/rest/corresp?id='$alid'&entity=https://moex.gitlabpages.inria.fr/alignapi/tutorial/myOnto.owl%23Article'
