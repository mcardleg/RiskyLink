...
public class MyApp {
	...
	*/
	...
	/*
	    ...
	    System.out.println( "NB Modles= "+model.countSubModels()+" ~~ "+model.hasLoadedImport( "https://moex.gitlabpages.inria.fr/alignapi/tutorial/tutorial4/ontology1.owl" ));
	    in.close();
	    model.loadImports();
	*/

	    OntClass cl = model.getOntClass( "https://moex.gitlabpages.inria.fr/alignapi/tutorial/tutorial4/ontology1.owl#Estudiante" ) ;
	    if ( cl != null ) {
