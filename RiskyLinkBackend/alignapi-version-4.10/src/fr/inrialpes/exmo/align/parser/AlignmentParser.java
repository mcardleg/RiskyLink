 ...
 * $Id$
 *
 * Copyright (C) INRIA, 2003-2005, 2007-2010, 2012-2015, 2017
 *
...
public class AlignmentParser {
	...
	if ( o instanceof String ) return p.parse( new ByteArrayInputStream( ((String)o).getBytes( StandardCharsets.UTF_8 ) ) );
