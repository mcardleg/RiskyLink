 ...
 * $Id$
 *
 * Copyright (C) INRIA, 2004-2005, 2007-2010, 2013-2015, 2017
 *
...
public abstract class GraphEvaluator {
    ...
    /**
     * @return the points to display in a graph
     ...
     *
     * @return a global value assessing the result
     */
	...
	if ( ascending ) {
	    cellSet = new TreeSet<EvalCell>(
				...
				public int compare( EvalCell o1, EvalCell o2 )
					...
					int comp = Double.compare( o1.cell.getStrength(), o2.cell.getStrength() );
					if ( comp > 0 ){
					    return -1;
					} else if ( comp < 0 ){
					    return 1;
     ...
     * 
     * @param al: the alignment to evaluate
     ...
     *
     * @param c: the cell to consider
     * @param ref: the reference alignment
     * @return true if the cell is correct
     */
