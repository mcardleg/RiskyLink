 ...
 * Copyright (C) INRIA, 2007-2015, 2017
 *
...
public class EDOALAlignment extends BasicAlignment {
	...
	setExtensions( al.extensions.convertExtension( "cloned", this.getClass().getName()+"#clone" ) );
    }

    public EDOALAlignment( URIAlignment al ) throws AlignmentException {
	this( (BasicAlignment)al );
    }
	...
	init( o1, o2, al.getRelationType(), al.getConfidenceType() );
	convertToEDOAL( al );
    }
    ...
    // and to use return new EDOALAlignment( new ObjectAlignment( al ) );
    // for URIAlignment
    //
    // Basic -> URI
    //       -> Object
	...
	return new EDOALAlignment( (BasicAlignment)al );
    }
    ...
    */
	...
	EDOALAlignment align = (EDOALAlignment)super.clone();
