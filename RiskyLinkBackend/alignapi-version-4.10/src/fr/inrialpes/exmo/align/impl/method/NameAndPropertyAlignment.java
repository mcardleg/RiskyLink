 ...
 *
 * Copyright (C) INRIA, 2003-2004, 2007-2010, 2013, 2017
 *
...
public class NameAndPropertyAlignment extends DistanceAlignment implements AlignmentProcess {
     ...
     * 
     * @param o1 and
     * @param o2: the two ontoogies to match
     * @param ontologies: an ontology cache
     ...
     * 
     * @param prop1 and
     * @param prop2: the two set of properties for a single class to match
