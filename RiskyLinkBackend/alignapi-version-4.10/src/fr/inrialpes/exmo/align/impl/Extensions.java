 ...
 * $Id$
 *
 * Copyright (C) INRIA, 2009-2010, 2014, 2017
 *
...
public class Extensions implements Cloneable {
    final static Logger logger = LoggerFactory.getLogger( Extensions.class );
	...
	Extensions ext;
	try {
	    ext = (Extensions)super.clone();
	} catch( CloneNotSupportedException cnsex ) {
	    logger.debug( "IGNORED Exception: alignment not cloned", cnsex );
	    return null; 
	}
	ext.table = (Hashtable<String,String[]>)table.clone(); //[W:unchecked]
	return ext;
    }    
}
