 ...
 * $Id$
 *
 * Copyright (C) INRIA, 2006-2010, 2012-2017
 *
...
public class HTMLMetadataRendererVisitor extends IndentedRendererVisitor implements AlignmentVisitor {
    ...
    protected String alid = null; // Used by further renderers
	...
	String printid = (alid==null )?"Anonymous alignment":alid;
	increaseIndent();
	if ( pid == null ) {
	    indentedOutputln("<h1>"+printid+"</h1>");
	} else {
	    indentedOutputln("<h1>"+printid+" ("+pid+")</h1>");
	}
