...
public class ExtPREvaluator extends BasicEvaluator implements Evaluator {
     ...
     *
     * @param align1 and
     * @param align2: two alignments on which extended precision and recall will be computed
     ...
     *
     * @param c1: the cell whose similarity is measured
     * @param s2: alignment against which similarity is computed
     * @return the symmetric similarity
     */
     ...
     * @param c1: the cell whose similarity is measured
     * @param s2: alignment against which similarity is computed
     * @return the effort-based similarity
     */
     ...
     * @param c1: the cell whose similarity is measured
     * @param s2: alignment against which similarity is computed
     * @return the precision-oriented similarity
     */
     ...
     * @param c1: the cell whose similarity is measured
     * @param s2: alignment against which similarity is computed
     * @return the recall-oriented similarity
     */
     ...
     *
     * @param o1 and
     * @param o2: two objects the position of which is computed
     * @param onto: the ontology to which the objects belong
     * @return the relative position:
     * 0: unrelated
     * n: o1 is a n-step sub-entity of o2
     * -n: o2 is a n-step sub-entity of o1
     * @throws AlignmentException when something goes wrong (typically objects do not belong to the ontology)
     */
     ...
     *
     * @param class1 and
     * @param class2: two classes superclass relationship is tested
     * @param ontology: the ontology to which the classes belong
     * @return the relation between these classes
     * @throws AlignmentException when something goes wrong
     */
