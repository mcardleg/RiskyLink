 ...
 *
 * Copyright (C) INRIA, 2009-2010, 2013-2014, 2020
 *
...
public class IDDLOntologyNetwork extends BasicOntologyNetwork implements LogicOntologyNetwork {
	...
	if ( reasoner == null ){
	    try {
		reasoner = new DRAON( allist );
	    } catch ( DRAONException iddlex ) {
		throw new AlignmentException( "Cannot initialise DRAONReasoner", iddlex );
	    }
