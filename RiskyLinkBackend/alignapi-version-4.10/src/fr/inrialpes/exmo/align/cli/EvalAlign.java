 ...
 * $Id$
 *
 * Copyright (C) INRIA, 2003-2008, 2010-2015, 2017
 *
...
public class EvalAlign extends CommonCLI {
	...
	if ( line.hasOption( 'i' ) ) evaluatorClass = Class.forName( line.getOptionValue( 'i' ) );
	...
	while ( totry ) {
		...
		if ( align1 instanceof ObjectAlignment ) {
		    ...
		    try {
			align1 = new ObjectAlignment( (URIAlignment)align1 );
			align2 = new ObjectAlignment( (URIAlignment)align2 );
			totry = true;
		    } catch ( AlignmentException aaex ) { throw alex; }
		}
	    }
	}
