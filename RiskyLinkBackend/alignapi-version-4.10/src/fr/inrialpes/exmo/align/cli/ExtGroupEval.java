 ...
 * $Id$
 *
 * Copyright (C) 2003-2005, 2007-2014, 2017 INRIA
...
public class ExtGroupEval extends CommonCLI {
	...
	try {
	    ...
	    eval = new ExtPREvaluator( new ObjectAlignment( (URIAlignment)align1 ), new ObjectAlignment( (URIAlignment)align2 ) );
	    // Compare
	...
	try {
		...
		//writer = new PrintStream( new FileOutputStream( outputfilename ), StandardCharsets.UTF_8.toString() );
		writer = new PrintStream( outputfilename, StandardCharsets.UTF_8.name() );
	    }
