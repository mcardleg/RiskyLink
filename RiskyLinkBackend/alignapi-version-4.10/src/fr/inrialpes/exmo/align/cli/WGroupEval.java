 ...
 * Copyright (C) Université de Montréal 2004
 *
...
public class WGroupEval extends CommonCLI {
    ...
    public void printTRIANGLE( Vector<Vector<Object>> result, PrintWriter writer ) {
    ...
    public void printLATEX( Vector<Vector<Object>> result, PrintWriter writer ) {
    }
...
which the program does...
    */
    ...
    public void printHTML( Vector<Vector<Object>> result, PrintWriter writer ) {
	// variables for computing iterative harmonic means
