...
public abstract class BasicAlterator implements Alterator {
	...
	//logger.trace( "-----> {}", base2 );
	    ...
	    // Currently we simply set the filename of ontologies in the alignments to their ontology id.
	    // This is likely to be incorrect but consistent if such Ids are dereferenceable
	    // This may be countered in TestGenerator.modifyOntology()
     ...
     *
     * @param ns: the namespace under which to relocate the ontology
     * @return the relocated ontology
     */
     ...
     *
     * @param base2: the namespace under which to relocate the ontology
     * @return the relocated ontology
     */
     ...
     *
     * @param model: the ontology whose URI have to be relocated
     * @param oldURI: the current URI prefix
     * @param newURI: the new URI prefix
     */
