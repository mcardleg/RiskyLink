 ...
 * $Id$
 *
 * Copyright (C) INRIA, 2003-2008, 2010, 2013, 2015, 2017
 *
...
public class JENAOntologyFactory extends OntologyFactory {
    ...
    private final static String formalismId = "OWL1.0";

    private final static OntologyCache<JENAOntology> cache = new OntologyCache<JENAOntology>();
