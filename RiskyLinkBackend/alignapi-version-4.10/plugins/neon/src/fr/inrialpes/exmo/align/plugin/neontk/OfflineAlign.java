 ...
 * $Id$
 *
 * Copyright (C) INRIA, 2007-2010, 2014-2015, 2020
 *
...
public class OfflineAlign {
	...
	//Integer name1 = Integer.valueOf(AlignView.alignId++);  
	//Integer name2 = Integer.valueOf(AlignView.alignId++);
	...
	Integer name = Integer.valueOf(AlignView.getNewAlignId());
