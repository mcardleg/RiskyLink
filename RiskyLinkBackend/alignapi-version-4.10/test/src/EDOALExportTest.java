 ...
 * Copyright (C) INRIA, 2009-2015, 2017-2018
 *
...
public class EDOALExportTest {
	...
	assertEquals( alignment.nbCells(), 16 );
        ...
        assertEquals(str1.length(), 11952);
    }
    ...
    public void testOWLRendering2() throws Exception {
        ...
        assertNotNull(alignment);
        EDOALAlignment edoal = new EDOALAlignment( (URIAlignment)alignment );
...
//        Assert.fail("HAVE TODO");
    ...
    public void testExportAlignment() throws Exception {
        ...
        Ontology<Object> o1 = new BasicOntology<Object>();
        o1.setURI(new URI("http://source"));
        o1.setFormalism("wsml");
        o1.setFormURI(new URI("http://wsml"));
        Ontology<Object> o2 = new BasicOntology<Object>();
